...
/**
 * Classe usata per salvare sul database o 
 * recuperare dal database informazioni relative ad un corso.
...
public class DriverManagerConnectionPool {
   ...
   * @throws SQLException (in caso non si stabilisce una connessione viene
   ...
   * @throws SQLException (in caso non esiste una connessione libera viene
   *                      lanciata un'eccezione)
   */
