/**
 * Classe usata per salvare sul database o recuperare dal database informazioni relative alla tipologia;
...
public class TipologiaBean {
	...
	public TipologiaBean() {
		...
		/**
	 * Questo metodo popola l'oggetto tipologia con la matricola del docente, la tipologia e il tempo;
