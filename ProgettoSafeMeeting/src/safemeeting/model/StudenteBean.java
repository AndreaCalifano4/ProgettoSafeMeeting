/**
 * Classe usata per salvare sul database o recuperare dal database informazioni relative allo studente;
...
public class StudenteBean implements Observer {
	...
	/**
	 * Questo metodo serve per controllare se ci sono messaggi; nel caso in cui ci siano li stampa;
	 */
	@Override
	public void update() {
