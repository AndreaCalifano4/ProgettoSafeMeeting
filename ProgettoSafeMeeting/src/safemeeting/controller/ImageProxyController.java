 ...
 * Questa servlet è l'implementazione per il design patter Proxy, se la foto non viene caricata in tempo verrà caricata una di default, idem se una foto non è presente.
 */
