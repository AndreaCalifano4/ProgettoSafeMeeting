...
/**
 * Questa servlet prende in input il giorno e l'orario in cui è assente un
 * docente e anche il messaggio inserito e, se va a buon fine, restituisce il
 * messaggio scritto allo studente ed elimina le prenotazioni in base all'ora e
 * il giorno inseriti dal docente.
 */
